...
class UmdHeaderConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['help_text'] = [
      '#markup' => '<p>If you wish to customize the UMD Header, paste the embed code generated from the <a href="https://umd-header.umd.edu/generator/">UMD Header Generator</a> here. You will also need to clear caches for the site in order to show changes.</p>',
    ];
    ...
    // URL of the API.
    $form['umd_schoolwide_header_settings']['embed'] = [
      '#type' => 'textarea',
